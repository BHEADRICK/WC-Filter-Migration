<?php
/**
 * WC_Filter_Migration Test Bootstrapper.
 *
 * @since   0.0.0
 ...
 * @since 0.0.0
 */
function _manually_load_wc_filter_migration_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/wc-filter-migration.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_wc_filter_migration_plugin' );
